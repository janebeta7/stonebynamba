...
public class DwShadertoy {
  ...
  public float         iR         = 0             ; // color r
  public float         iG         = 0             ; // color r
  public float         iB         = 0             ; // color r
  public float         iR2         = 0             ; // color r
  public float         iG2         = 0             ; // color r
  public float         iB2         = 0             ; // color r
   public float         ALFA_toy         = 1             ; // color r
  ...
  public void  set_u_color_g(float r) {
    iG = r;
  }
  public void  set_u_color_b(float r) {
    iB= r;
  }

  public void  set_u_color_r(float r) {
    iR = r;
  }
  public void  set_ALFA(float r) {
    ALFA_toy = r;
      // println("ALFA_toy:"+ALFA_toy);
  }

  public void  set_u_color_g2(float r) {
    iG2 = r;
 
  }
  public void  set_u_color_b2(float r) {
    iB2= r;
  }

  public void  set_u_color_r2(float r) {
    iR2 = r;
  }
  ...
  protected void render(int w, int h) {
    ...
    shader.uniform1f     ("iR", iR               );
    shader.uniform1f     ("iG", iG               );
    shader.uniform1f     ("iB", iB               );
    shader.uniform1f     ("iR2", iR2               );
    shader.uniform1f     ("iG2", iG2              );
    shader.uniform1f     ("iB2", iB2               );
    shader.uniform1f     ("ALFA", ALFA               );
    shader.uniform1f     ("TRESHOLD", TRESHOLD               );
     shader.uniform1f     ("DISPLACEMENT", DISPLACEMENT               );
